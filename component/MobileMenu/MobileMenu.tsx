...
import ClipboardCheckIcon from "component/icons/ClipboardCheck"
import LoginIcon from "component/icons/Login"
						...
						<div className="border-t border-gray-200 py-6 mr-16 w-full">
							{menuItems &&
								...
								menuItems.map((menuItem) => {
									if (menuItem && (menuItem.childItems?.nodes?.length ?? 0) > 0) {
										return (
											<div className="flow-root pt-2" key={menuItem.id}>
												...
												<div className="pt-2">
													{menuItem.childItems?.nodes.map((child: MenuItem | null | undefined) => {
														if (child)
															return (
																<div
