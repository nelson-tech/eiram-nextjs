 ...
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(source: "mutation ClearCart($input: EmptyCartInput!) {\n  emptyCart(input: $input) {\n    clientMutationId\n    cart {\n      ...CartBase\n    }\n  }\n}"): (typeof documents)["mutation ClearCart($input: EmptyCartInput!) {\n  emptyCart(input: $input) {\n    clientMutationId\n    cart {\n      ...CartBase\n    }\n  }\n}"];
/**
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
 ...
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(source: "query GetMenus {\n  mainMenu: menu(id: \"main\", idType: SLUG) {\n    id\n    menuItems(first: 100, where: {parentDatabaseId: 0}) {\n      nodes {\n        id\n        url\n        label\n        childItems {\n          nodes {\n            id\n            url\n            label\n          }\n        }\n      }\n    }\n    siteSettings {\n      colors {\n        accent\n        black\n        blue\n        green\n        highlight\n        indigo\n        orange\n        red\n        violet\n        white\n        yellow\n      }\n      footer {\n        socialmedia {\n          icon {\n            name\n            style\n          }\n          link\n          name\n        }\n      }\n    }\n  }\n}"): (typeof documents)["query GetMenus {\n  mainMenu: menu(id: \"main\", idType: SLUG) {\n    id\n    menuItems(first: 100, where: {parentDatabaseId: 0}) {\n      nodes {\n        id\n        url\n        label\n        childItems {\n          nodes {\n            id\n            url\n            label\n          }\n        }\n      }\n    }\n    siteSettings {\n      colors {\n        accent\n        black\n        blue\n        green\n        highlight\n        indigo\n        orange\n        red\n        violet\n        white\n        yellow\n      }\n      footer {\n        socialmedia {\n          icon {\n            name\n            style\n          }\n          link\n          name\n        }\n      }\n    }\n  }\n}"];
/**
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
 ...
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(source: "query GetPageBySlug($slug: ID!) {\n  page(id: $slug, idType: URI) {\n    ...PageCommonBase\n    content\n  }\n}"): (typeof documents)["query GetPageBySlug($slug: ID!) {\n  page(id: $slug, idType: URI) {\n    ...PageCommonBase\n    content\n  }\n}"];
/**
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(source: "query GetPress {\n  press(first: 100) {\n    nodes {\n      id\n      title\n      content\n      featuredImage {\n        node {\n          ...ImageBase\n        }\n      }\n      slug\n    }\n  }\n}"): (typeof documents)["query GetPress {\n  press(first: 100) {\n    nodes {\n      id\n      title\n      content\n      featuredImage {\n        node {\n          ...ImageBase\n        }\n      }\n      slug\n    }\n  }\n}"];
/**
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
