...
const useAuth = () => {
  ...
  const [processing, setProcessing] = useState(
    !processingStates.includes(state.value as string)
  )
      ...
      callback: (success) => {
        success
          ...
          : openAlert({
              ...
              secondary:
                "Please check that you've entered the correct email address.",
              timeout: 5000,
            })
      },
    }
      ...
      callback: (success, firstName) => {
        success
          ...
          : openAlert({
              ...
              secondary:
                "Please check that you've entered the correct email address and key.",
              timeout: 5000,
            })
