...
export interface Typegen0 {
  ...
  internalEvents: {
    ...
    "error.platform.clearCart": {
      type: "error.platform.clearCart"
      data: unknown
    }
    "error.platform.fetchCart": {
      type: "error.platform.fetchCart"
      data: unknown
    }
    "error.platform.passRemoveKey": {
      type: "error.platform.passRemoveKey"
      data: unknown
    }
    "error.platform.passUpdateKey": {
      type: "error.platform.passUpdateKey"
      data: unknown
    }
    "error.platform.removeItem": {
      type: "error.platform.removeItem"
      data: unknown
    }
    "error.platform.updateCartItem": {
      type: "error.platform.updateCartItem"
      data: unknown
    }
