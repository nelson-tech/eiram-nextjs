	...
	return (
		<div id="order-pending" className="space-y-8">
			...
			<div className="mt-2 text-base text-gray-500">
				<p>Your order #{orderNumber} has been received, but the payment was incomplete.</p>
				<p className="text-base text-gray-500 bg-yellow-50 rounded-md p-4 mt-8">
					...
					with your order number to complete your payment so we can get your order to you as quickly
					as possible.
				</p>
			</div>
		</div>
